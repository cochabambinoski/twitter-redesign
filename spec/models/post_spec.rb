...
RSpec.describe Post, type: :model do
  before :each do
    @user = User.create!(email: 'user1@dunno.com', username: 'user1', fullname: 'user1', password: '123456')
    @post = Post.create(content: 'text123', user_id: @user.id)
    @post2 = Post.create(content: 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit.
      Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis
       ...
       ugue velit cursus nunc,', user_id: @user.id)
  end
